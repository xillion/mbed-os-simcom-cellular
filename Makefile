...
PROJECT := mbed-os-simcom-cellular
...
OBJECTS += ./SIMCOM_SIM800C/SIMCOM_SIM800C.o
OBJECTS += ./main.o
...
INCLUDE_PATHS += -I../.
INCLUDE_PATHS += -I.././SIMCOM_SIM800C
...
INCLUDE_PATHS += -I..//home/embedder/Projects/MBED/mbed-os-simcom-cellular/mbed-os
...
C_FLAGS += -DMBED_BUILD_TIMESTAMP=1594936019.2873569
...
CXX_FLAGS += -DMBED_BUILD_TIMESTAMP=1594936019.2873569
...
ASM_FLAGS += -I../mbed-os/features/cellular/framework/targets/TELIT/ME310
...
ASM_FLAGS += -I/home/embedder/Projects/MBED/mbed-os-simcom-cellular/mbed-os
ASM_FLAGS += -include
